...
public class Repair { // WO
    ...
    @NotNull
    @Size(min=10,max=50,message="Please make an short and precise description (10-50 characters)") //Message er custom fejlbesked
    private String repair_description;
    @NotNull
    @Size(min=10,max=10,message="Must be in dateformat: YYYY-MM-DD") //Message er custom fejlbesked
