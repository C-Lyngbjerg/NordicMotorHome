...
@Repository
public class RepairRepo implements RepositoryI {// WO

    @Autowired
    JdbcTemplate template;

    public List<Repair> fetchAll(){// WO
    ...
    public Repair add(Object obj){// WO
    ...
    public Repair findById(int id){// WO
    ...
    public Boolean delete(int id){// WO
        String sql = "DELETE FROM repairs WHERE repair_id = ?";
        return template.update(sql,id) < 0;
    }

    public Repair update(Object obj){// WO
        Repair repair = (Repair) obj;
