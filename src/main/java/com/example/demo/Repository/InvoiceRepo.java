...
@Repository
public class InvoiceRepo implements RepositoryI{ //WO & CB
...
/*  fetchAll() henter data fra table invoices i databasen, via et (DML) SQL statement, der sammen med en rowMapper
    ...
    fra databasen.
 */
    public List<Invoice> fetchAll(){ // WO
    ...
    public Invoice add(Object object){ //WO
    ...
    public Invoice findById(int id){ //CB
    ...
    public Boolean delete(int id){ // WO & CB
     ...
     */
    public Invoice update(Object object){ //WO & CB
        Invoice invoice = (Invoice) object;
    ...
    public Boolean checkContractId(int contract_id){ // CB
